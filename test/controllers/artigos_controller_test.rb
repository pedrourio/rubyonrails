...
class ArtigosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create artigo" do
    assert_difference("Artigo.count") do
      post artigos_url, params: { artigo: { content: @artigo.content, title: @artigo.title } }
    end
  ...
  test "should update artigo" do
    patch artigo_url(@artigo), params: { artigo: { content: @artigo.content, title: @artigo.title } }
